...
classifier = cv2.CascadeClassifier(r"D:/CTTC/GCEK Face detect/GCEK Face detect/haarcascade_frontalface_default (1).xml")

model = load_model(r"D:/CTTC/GCEK Face detect/GCEK Face detect/fac.h5")
